...
exports.PureComponent = exports.Children = exports["default"] = void 0;
...
function onLoad(PageClass, path, query, isLoad) {
  ...
  if (typeof GlobalApp === "function") {
    ...
    pageInstance = render(createElement(PageClass, {
      path: path,
      query: query,
      isPageComponent: true
    }), container);
...
React.api.setStorageSync = function () {
  fn.apply(void 0, arguments);

  if (typeof (arguments.length <= 0 ? undefined : arguments[0]) === 'string') {
    React.api.getStorageSync(arguments.length <= 0 ? undefined : arguments[0]);
  }
};
