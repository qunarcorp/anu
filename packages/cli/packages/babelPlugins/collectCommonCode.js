    ...
    function () {
        return {
            ...
            post() {
                ...
                const __runtimecommon = global.useCache ? path_1.default.join(global.cacheDirectory, `internal_${global.nanachiVersion}/runtimecommon.js`) : path_1.default.join(cwd, '../../dist', 'internal/runtimecommon.js');
